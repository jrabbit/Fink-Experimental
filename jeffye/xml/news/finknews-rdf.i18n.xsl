...
<xsl:template match="news">
 <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:rss091="http://purl.org/rss/1.0/modules/rss091#" xmlns="http://purl.org/rss/1.0/">
  <channel rdf:about="http://fink.sourceforge.net/news/">
   ...
   <rss091:language rdf:parseType="Literal" xmlns="" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><xsl:value-of select="@lang" /></rss091:language>
  </channel>
...
<xsl:choose>
  <xsl:when test="boolean(headline)">
    <xsl:variable name="headline-uri"><xsl:value-of select="date" /><xsl:text> </xsl:text><xsl:value-of select="headline/@ref" /></xsl:variable>
