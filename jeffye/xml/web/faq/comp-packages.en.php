...
<h1>F.A.Q. - 7 Compile Problems - Specific Packages</h1>
    ...
    <a name="libgtop">
      <div class="question"><p><b>Q7.1: A package fails to build with errors involving <code>sed</code>.</b></p></div>
...
echo Hello
    ...
    <a name="cant-install-xfree">
      <div class="question"><p><b>Q7.2: I want to switch to Fink's XFree86 packages, but I can't install <code>xfree86-base</code> | <code>xfree86</code>, because it conflicts with <code>system-xfree86</code>.</b></p></div>
...
sudo dpkg -r --force-depends xfree86-rootless-threaded-shlibs
  ...
  <p align="right">
Next: <a href="usage-general.php?phpLang=en">8 Package Usage Problems - General</a></p>
