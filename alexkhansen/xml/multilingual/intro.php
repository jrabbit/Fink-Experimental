...
$metatags = '<link rel="contents" href="index.php" title="i18n Contents"><link rel="next" href="files.php" title="The Documentation Files"><link rel="prev" href="index.php" title="i18n Contents">';
...
<h1>i18n - 1 Introduction</h1>
    ...
    <h2><a name="what">1.1 What is going on with internationalization of the Fink website?</a></h2>
...
which pages in multiple languages can be employed
    ...
    <h2><a name="organization">1.3 Organization</a></h2>
...
for you to have CVS access to the documentation section.</li>
  ...
  <p align="right">
Next: <a href="files.php">2 The Documentation Files</a></p>
