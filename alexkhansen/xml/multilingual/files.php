...
<pre>cd ~/Documents/Fink-i18n</pre>
    ...
    <p>If the file already exists, you can skip to the next step.</p>
            ...
            <li>In Terminal 1, commit the web tree:<pre>cvs -z3 -d:ext:username@cvs.sourceforge.net:/cvsroot/fink ci web</pre>
              <p>Enter your SourceForge Password at the prompt.  You may get a message about the DSA key of the server.  Go ahead and anwer yes.</p>
            </li>
            <li>Now in Terminal 2, run<pre>make &amp;&amp; make install</pre>
            </li>
            <li>If the XML file was new, you'll need to do some more CVS adding.  There should be a couple of lines that start with cp when you run make install, e.g.<pre>cp 
cp</pre>You'll want to add every file in those directories.  For the example above, In Terminal 1 you would run:<pre>cvs -z3 -d:ext:yourusername@cvs.sourceforge.net:/cvsroot/fink add download.ru.php</pre>
            </li>
            <li>In Terminal 1, commit the web tree again:<pre>cvs -z3 -d:ext:username@cvs.sourceforge.net:/cvsroot/fink ci web</pre>
              <p>Enter your SourceForge Password at the prompt.  You may get a message about the DSA key of the server.  Go ahead and anwer yes.</p>
            </li>
          </ol>
        </li>
