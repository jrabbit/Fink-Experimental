...
<xsl:template match="document" href="{@filename}{$lang-ext}.html">
<html><head>
...
<li>
  <a><xsl:attribute name="href"><xsl:text>#</xsl:text><xsl:value-of select="@filename"/><xsl:value-of select="$lang-ext"/></xsl:attribute>
  ...
  <ul>
	...
	<xsl:text>#</xsl:text><xsl:value-of select="../@filename" /><xsl:value-of select="$lang-ext"/><xsl:text>.</xsl:text><xsl:value-of select="@name" />
	</xsl:attribute>
...
<h3><a name="{../@filename}{$lang-ext}.{@name}">
...
<a name="{../@filename}{$lang-ext}.{@name}"><xsl:apply-templates/></a>
</xsl:template>
